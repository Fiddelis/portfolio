...
export default function Contact() {
  return (
    <motion.section
      id="contact"
      className="flex flex-col mb-16 font-bold mt-60"
    ...
    >
      ...
      <Card className="flex gap-6 justify-center max-w-min p-2 self-center bg-secondary text-background">
        <a href="https://www.linkedin.com/in/lucas-ruan-fidelis">
          <SiLinkedin className="w-10 h-10 drop-shadow-lg/30" />
        </a>

        <a href="https://github.com/Fiddelis">
          <SiGithub className="w-10 h-10 drop-shadow-lg/30" />
        </a>
        <a href="https://discord.com/users/210895480429871104">
          <SiDiscord className="w-10 h-10 drop-shadow-lg/30" />
        </a>
        <a href="https://www.instagram.com/lucasruan.ff">
